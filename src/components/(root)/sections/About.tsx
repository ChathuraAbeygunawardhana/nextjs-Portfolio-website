...
const About = () => {
  ...
  return (
    <section
      className="relative mt-20 min-h-screen overflow-x-clip px-20 max-md:px-4"
      id="section-about"
    >
      ...
      <LetterFade
        ...
        highlightWords={["Chathura"]}
      >
        Hi, I&apos;m Chathura, a self-taught Full Stack Developer with over a
        year of hands-on experience in building and designing web applications.
        While I haven&apos;t had the chance to take on internships or
        professional roles yet, my passion for exploring new technologies and
        ...
        am always eager to dive into the latest tools and frameworks to craft
